        ...
        <div class="page">
            <div class="subpage">
                <div class="display-inline">
                    <img class="wrapimage"
                        src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents(storage_path('private_assets/images/attendance_tag.png'))) }}"
                        alt="">
                    <div class="wrap-title">
                        <p>{{ $participant->event_name }}</p>
                        <p class="subtitle">{{ $participant->location }} -
                            {{-- {{ \Carbon\Carbon::parse($participant->event_date)->isoFormat('D MMMM Y') }}</p> --}}
                    </div>

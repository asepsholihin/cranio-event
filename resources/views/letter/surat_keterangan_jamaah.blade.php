        ...
        <div class="page">
            ...
            <div class="subpage">
                ...
                <div class="center mt-5">
                    <h4 class="mb-0 underline">SURAT KETERANGAN</h4>
                ...
                <div class="left mt-5">
                    <span class="fw-bold">
                        Kepada Yth. <br>
                        {{$letterInformation->destination_permission??'Pimpinan Perusahaan'}}<br>
                        {{$letterInformation->address_permission??'Di Tempat'}}
                    </span>
                </div>
                ...
                <div class="left mt-3">
                    ...
                    Dengan surat ini, kami menerangkan bahwa nama yang tertera dibawah ini terdaftar sebagai jama'ah <span class="fw-bold">{{ $tripCategory }} Paket {{ucwords(strtolower($packageUmrohTrip->name))}}, Keberangkatan {{ \Carbon\Carbon::parse($umrohTrip->departure_at)->isoFormat('D MMMM Y') }} - {{ \Carbon\Carbon::parse($umrohTrip->return_at)->isoFormat('D MMMM Y') }}</span>, dengan rincian sebagai berikut:
                    </p>
                </div>
                ...
                <div class="left mt-3">
                    <table width="100%">
                        <tr>
                            <td width="15%">Nama</td>
                            <td width="2%">:</td>
                            <td class="uppercase">{{ ucwords(strtolower($participant->name)) }}</td>
                        </tr>
                        <tr>
                            <td width="15%">Jabatan</td>
                            <td width="2%">:</td>
                            <td class="uppercase">{{ ucwords(strtolower($participant->job)) }}</td>
                        </tr>
                    </table>
                </div>

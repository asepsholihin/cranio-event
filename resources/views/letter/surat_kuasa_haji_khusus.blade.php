...
<head>
    ...
    <title>SURAT KUASA, PERJANJIAN, PERNYATAAN HAJI KHUSUS PT. JEJAK IMANI BERKAH BERSAMA</title>
</head>
        ...
        <div class="page">
            <div class="subpage">
                <div class="main">
                    ...
                    <div class="center">
                        <h1 class="mt-5 mb-0" style="text-decoration:underline">SURAT KUASA</h1>
                    </div>
                    ...
                    <div class="left mt-5">
                        ...
                        <table width="100%" style="margin-left:24px">
                            <tr>
                                ...
                                <td class="uppercase"><span class="fw-bold">{{ strtoupper($participant->name) }}</span></td>
                            </tr>
                            <tr>
                                <td valign="top">No. KTP</td>
                                <td valign="top">:</td>
                                <td class="uppercase">{{ $participant->nik }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="uppercase">Islam</td>
                            </tr>
                        </table>
                    </div>

                    <div class="left mt-3">
                        <p>Dengan ini memberi tugas kepada Divisi Haji dan Umroh <span class="fw-bold" style="margin-left:6px">PT Jejak Imani Berkah Bersama</span> untuk pengurusan mengambil Surat Pendaftaran Pergi Haji (SPPH) Kementerian Agama kepada:</p>
                        <br>
                        <table width="100%" style="margin-left:24px">
                            <tr>
                                <td valign="top" width="28%">Nama</td>
                                <td valign="top" width="2%">:</td>
                                <td class="uppercase"><span class="fw-bold">FADILAH RAMADHAN</span></td>
                            </tr>
                            <tr>
                                <td valign="top">NIK</td>
                                <td valign="top">:</td>
                                <td>3674033012980002</td>
                            </tr>
                            <tr>
                                <td valign="top">Tempat/Tanggal Lahir</td>
                                <td valign="top">:</td>
                                <td class="uppercase">Jakarta, 30 Desember 1998</td>
                            </tr>
                            <tr>
                                <td valign="top">Alamat</td>
                                <td valign="top">:</td>
                                <td class="uppercase">Jl. Kucica I Blok JG 4 No. 2 Bintaro Sektor IX RT. 003 RW. 011 Kel. Pondok Pucung, Kec. Pondok Aren, Kota Tangerang Selatan, Banten</td>
                            </tr>
                        </table>
                    </div>

                    <br>
                    <p>Demikian surat tugas ini dibuat dalam keadaan sadar tanpa tekanan dari suatu pihak. Semoga surat kuasa ini dapat menjadi jaminan kepada pihak yang berkepentingan.</p>
                    
                    <p class="mt-3">Tangerang Selatan, {{ \Carbon\Carbon::now()->isoFormat('D MMMM Y') }}</p>
                        ...
                        <table width="100%">
                            <tr>
                                <td width="50%" valign="top">
                                    <p>Pemberi kuasa,</p>
                                    <br><br><br><br><br>
                                    <p><span style="text-decoration:underline" class="fw-bold uppercase">{{ strtoupper($participant->name) }}</span><br>Calon Participant Haji</p>
                                </td>
                                <td width="50%" valign="top">
                                    <p>Yang dikuasakan,</p>
                                    <br><br><br><br><br>
                                    <p><span style="text-decoration:underline" class="fw-bold uppercase">FADILAH RAMADHAN</span><br>Div. Haji & Umrah</p>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="main">
                    ...
                    <div class="left mt">
                        <p>Dalam hal ini bertindak untuk dan atas nama <strong>PT Jejak Imani Berkah Bersama</strong> sebagai Penyelenggara Ibadah Haji Khusus berdasarkan Surat Keputusan Kementerian Agama RI No. 394 tahun 2021 selanjutnya disebut sebagai <span class="fw-bold">PIHAK PERTAMA</span>.</p>
                        <table width="100%" style="margin-left:24px">
                            <tr>
                                <td width="28%">Nama</td>
                                <td width="2%">:</td>
                    ...
                    <div class="left mt">
                        ...
                        <ol>
                            <li class="justify">
                                Bahwa sesuai dengan Keputusan Direktur Jenderal Bimbingan Masyarakat Islam dan Pelayanan Haji No.:D/405 tahun 2012 tentang perubahan atas keputusan Direktur Jenderal Penyelenggaraan Haji dan Umroh No.:D/186 tahun 2012 tentang petunjuk Teknis Pelunasan Biaya Penyelenggara Ibadah Haji dan Pengurusan Dokumen Haji Khusus tahun 1436H/2015M Pasal 19 Ayat 1, <span class="fw-bold">PIHAK PERTAMA</span> selaku Penyelenggara Ibadah Haji Khusus antara lain berkewajiban untuk membuat dan menandatangani perjanjian dengan setiap calon jemaah yang berisi hak dan kewajiban PARA PIHAK (selanjutnya disebut sebagai “Perjanjian”).
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td width="50%" valign="top">
                                    ...
                                    <br><br><br>Materai 10.000<br><br><br>
                ...
                <div class="main">
                    ...
                    <div class="center">
                        <h1 class="mt-5 mb-0" style="text-decoration:underline">SURAT PERNYATAAN</h1>
                    </div>
                    ...
                    <div class="left mt">
                        <ol>
                            <li class="justify">
                                Apabila pada tahun berjalan porsi jemaah Haji Khusus telah terpenuhi, maka bersedia menjadi waiting list.
                            </li>
                            <li class="justify">
                                Apabila terjadi pembatalan, dana setoran BPIH Khusus akan dikembalikan ke rekening jemaah yang bersangkutan dan apabila meninggal dunia dikembalikan ke rekening ahli waris yang bersangkutan (sesuai fatwa waris). 
                            </li>
                        </ol>
                    </div>
                    ...
                    <div class="left mt-3">
                        <p class="justify">
                            Demikianlah pernyataan ini saya buat dengan sesungguhnya, agar dapat dipergunakan sebagaimana mestinya.
                        </p>
                    </div>

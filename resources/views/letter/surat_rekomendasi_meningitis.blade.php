        ...
        <div class="page">
            ...
            <div class="subpage">
                ...
                <div class="center mt-5">
                    <h4 class="mb-0 underline">SURAT REKOMENDASI</h4>
                ...
                <div class="left mt-5">
                    <span class="fw-bold">
                        Kepada Yth.<br>
                        {{$letterInformation->destination_hospital??'-'}}<br>
                        {{$letterInformation->address_hospital??'Di Tempat'}}
                    </span>
                </div>
                ...
                <div class="left mt-3">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>Keperluan</td>
                            <td>:</td>
                            <td class="uppercase"><span class="fw-bold">Pembuatan Kartu Meningitis</span></td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="left mt-3">
                    <p class="justify indent">
                        Nama di atas adalah peserta/participant umrah <span class="fw-bold">PT. Jejak Imani Berkah Bersama</span> dengan izin nomor U.533 Tahun 2020 yang akan melaksanakan <span class="fw-bold">{{ $tripCategory }} mulai tanggal {{ \Carbon\Carbon::parse($umrohTrip->departure_at)->isoFormat('D MMMM Y') }} - {{ \Carbon\Carbon::parse($umrohTrip->return_at)->isoFormat('D MMMM Y') }}</span>. Terkait hal tersebut, kami memberikan rekomendasi untuk melakukan suntik meningitis sebagai salah satu syarat melaksanakan ibadah umrah.
                    </p>
                    <p class="justify indent">
                        Demikian surat permohonan ini kami sampaikan untuk dipergunakan sebagaimana mestinya. Atas kerja sama dan perhatian Bapak/Ibu, kami ucapkan terima kasih.
                    </p>
                </div>

                <div class="center mt-5">
                    <h4 class="mb-0 fw-bold">PT. JEJAK IMANI BERKAH BERSAMA</h4>
                    <p>Direktur Utama</p>

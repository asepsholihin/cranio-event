...
<body>
    @if(str_contains($documentStyle, "sapphire") || str_contains($documentStyle, "emerald"))
        <div class="book">
            <div class="page">
                <div class="subpage">
                    <div class="main">
                        @foreach($participants as $participant)
                            @php
                            $fullname = $participant->name_in_passport??$participant->name;
                            $fontSize = "10px";
                            ...
                            <div class="wrap-content">
                                <div class="display-inline">
                                    <img class="wrapimage" src="{{'data:image/png;base64,'.base64_encode(file_get_contents(storage_path('private_assets/images/luggage_jelajah_dunya.png')))}}" alt="">
                                    ...
                                    <div class="wrap-room">
                                        <p>{{strtoupper($participant->no_urut)}}</p>
                                    </div>
                                    ...
                                    <div class="wrap-name" style="font-size:{{$fontSize}};">
                                        <p>{{strtoupper($participant->name_in_passport??$participant->name)}}</p>
                                    </div>
                                    <div class="wrap-passport" style="font-size:{{$fontSize}};">
                        ...
                        <tr>
                            ...
                            <td rowspan="2" valign="bottom">
                                <div class="display-vertical">
                                    <img class="wrapimage" src="{{'data:image/png;base64,'.base64_encode(file_get_contents(storage_path('private_assets/images/luggage_ruby_vertical.png')))}}" alt="">
                                    <div class="rotate-90">
                                        <div class="wrap-avatar">
                                            <div class="container-svg">  
                                                <div class="subcontainer-svg"> 
                        ...
                        <tr>
                            <td colspan="3">
                                <div class="display-horizontal">
                                    <img class="wrapimage" src="{{'data:image/png;base64,'.base64_encode(file_get_contents(storage_path('private_assets/images/luggage_ruby_horizontal.png')))}}" alt="">
                                    <div class="wrap-avatar">
                                        <div class="container-svg">  
                                            <div class="subcontainer-svg"> 
                                                <img class="img-svg" src="{{$participant->profile_thumbnail}}"  />

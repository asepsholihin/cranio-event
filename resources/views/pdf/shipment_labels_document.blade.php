...
<head>
    ...
    <title>Shipment Label - Document</title>
</head>
<body>
    <div class="book">
        @foreach($documentDeliveries as $participant)
        <div class="page">
            <div class="letter-bg">
            ...
            <div class="subpage">
                <div class="card">
                    ...
                    <p><strong>{{ ucwords(strtolower($participant->recipient_name ?? $participant->name)) }}</strong></p>
                        ...
                        <tr>
                            ...
                            <td valign="top" width="80%">
                                @foreach($participant->documents as $key => $document)
                                    {{($key+1)}}. {{ $document->document_name }}<br>
                                @endforeach
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top">:</td>
                            <td valign="top" class="uppercase">{{ $participant->deliveryAddress['address'] }}, Kel. {{ $participant->deliveryAddress['subdistrict'] }}, Kec. {{ $participant->deliveryAddress['district'] }},
                                {{ $participant->deliveryAddress['city'] }}, {{ $participant->deliveryAddress['province'] }}, {{ $participant->deliveryAddress['postalcode'] }}</td>
                        </tr>
                        <tr>

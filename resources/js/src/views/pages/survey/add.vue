...
import { postData } from '@/network/survey'
...
export default {
    ...
    methods: {
        resetForm() {
            this.formData = { status:true, questions: [{has_other: false, option_value:[]}] }
        },
        addQuestion() {
            this.formData.questions.push({has_other: false, option_value:[]})
        },
        ...
        onSubmit() {
            this.$refs.refObsForm.validate().then(success => {
                ...
                postData(vForm).then(response => {
                    this.$bvToast.toast('Survey has been created successfully', {
                        title: `Success`,
                        variant: 'primary',
    ...
    data() {
        const formData = {
            status:true,
            questions: [{has_other: false, option_value:[]}]
        }

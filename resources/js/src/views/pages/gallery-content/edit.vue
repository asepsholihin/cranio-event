      ...
      <b-form @submit.prevent="onSubmit">
        ...
        <validation-observer ref="refObsForm">
          ...
          <b-media class="mb-2">
              ...
              <b-button v-if="hasPermission('asatidz-add-or-edit')" variant="primary" @click="$refs.refInputEl.click()">
              ...
              <div class="mt-1 text-muted">Recommended Size 1080 x 800 px (Format : PNG, JPG, WEBP) Max Size: 1.5MB</div>
          </b-media>
          ...
          <div class="d-flex mt-2">
            <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" class="mr-2" type="submit"
              v-if="hasPermission('gallery-add-or-edit')">
              Save Changes
            </b-button>
...
import { getDetail, postData } from '@/network/gallery-content'
  ...
  methods: {
    ...
    searchCategory: _.debounce((loading, searchCategory, vm) => {
      getCategoriesSearch({ q: searchCategory })
        ...
        .catch(error => {
          vm.$bvToast.toast(`Error: ${error}`, { title: `Error`, variant: 'danger', toaster: 'b-toaster-top-center', solid: true })
          loading(false)
        })
    }, 300),
  },

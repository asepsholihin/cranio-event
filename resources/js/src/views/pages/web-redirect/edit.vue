            ...
            <b-form @submit.prevent="onSubmit">
                ...
                <validation-observer ref="refObsForm">
                    ...
                    <b-row>
                        ...
                        <!-- Old URL -->
                        <b-col cols="12" md="4">
                            <validation-provider #default="{ errors }" name="New URL" vid="new_url" rules="required">
                        ...
                        <!-- New URL -->
                        <b-col cols="12" md="4">
                            <validation-provider #default="{ errors }" name="Old URL" vid="old_url" rules="required">
                                <b-form-group label="Old URL">
                                <b-form-input id="old_url" v-model="formData.old_url" :state="errors.length > 0 ? false : null"
                                trim />
...
import { getDetail, postData } from '@/network/web-redirect'
...
export default {
        ...
        onSubmit() {
            this.$refs.refObsForm.validate().then(success => {
                ...
                postData(vForm).then(response => {
                    this.$bvToast.toast('Redirect has been changed successfully', {
                        title: `Success`,
                        variant: 'primary',
    ...
    data() {
        ...
        return {
            formData, required, numeric, redirectTypeOption
        }
    }
}
</script>

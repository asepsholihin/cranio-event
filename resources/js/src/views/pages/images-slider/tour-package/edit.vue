                ...
                <validation-observer ref="refObsForm">
                    ...
                    <b-media class="mb-2">
                        ...
                        <div class="d-flex flex-wrap">
                            <b-button v-if="hasPermission('images-slider-add-or-edit')" variant="primary"
                    ...
                    <b-row>
                        ...
                        <b-col cols="12">
                            <validation-provider #default="{ errors }" name="Alt Image" vid="alt_image" rules="required">
                                <b-form-group label="Alt Image">
                                    <b-form-input id="alt_image" v-model="formData.alt_image"
                        ...
                        <!-- Title Image -->
                        <b-col cols="12">
                            <validation-provider #default="{ errors }" name="Title Image" vid="title_image"
                                rules="required">
                                <b-form-group label="Title Image">
                                    <b-form-input id="title_image" v-model="formData.title_image"
                                        :state="errors.length > 0 ? false : null" trim />
                        ...
                        <b-col cols="12" md="4">
                            <validation-provider #default="{ errors }" name="Order" vid="order" rules="required|numeric">
                                <b-form-group label="Order">
                                    <b-form-input id="order" v-model="formData.order"
                                        :state="errors.length > 0 ? false : null" trim />
                        ...
                        <!-- Button Title -->
                        <b-col cols="12" md="4">
                            <validation-provider #default="{ errors }" name="Button Title" vid="button_title"
                                rules="required">
                                <b-form-group label="Button Title">
                                    <b-form-input id="button_title" v-model="formData.button_title"
                                        :state="errors.length > 0 ? false : null" trim />
...
import { getDetail } from '@/network/web-tour-package'
import { ValidationProvider, ValidationObserver } from 'vee-validate'
import { required, numeric } from '@validations'
import Ripple from 'vue-ripple-directive'
import vSelect from 'vue-select'
import { avatarText } from '@core/utils/filter'
import { postData } from '@/network/web-tour-package'
        ...
        onSubmit() {
            this.$refs.refObsForm.validate().then(success => {
                ...
                postData(vForm).then(response => {
                    this.$bvToast.toast('Tour Package has been changed successfully', {
                        title: `Success`,
                        variant: 'primary',

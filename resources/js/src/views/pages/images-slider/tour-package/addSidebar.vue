    ...
    <template #default="{ hide }">
      ...
      <validation-observer ref="refObsForm">
        ...
        <b-form class="p-2" @submit.prevent="onSubmit" @reset.prevent="resetMainVisualData">
          ...
          <!-- Button Title -->
          <validation-provider #default="{ errors }" name="Button Title" vid="button_title" rules="required">
            <b-form-group label="Button Title">
              <b-form-input id="button_title" v-model="formData.button_title" :state="errors.length > 0 ? false : null"
              trim />
          ...
          <validation-provider #default="{ errors }" vid="image" name="Image" rules="required">
            <b-form-group label="Image" description="Recommended Size 750 x 750 px (Format : PNG, JPG, WEBP) Max Size: 1.5MB">

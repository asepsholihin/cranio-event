          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button variant="primary" @click="isAddSidebarActive = true" v-if="hasPermission('images-slider-add-or-edit')">
                <span class="text-nowrap">Add Footer Logo</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchSales" responsive hover
        ...
        <template #cell(actions)="data">
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item :to="{ name: 'footer-logo-detail', params: { id: data.item.id } }">
...
import { deleteData } from '@/network/web-footer-logo'

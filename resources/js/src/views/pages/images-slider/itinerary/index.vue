<template>
  <div>
    <add-sidebar :is-add-sidebar-active.sync="isAddSidebarActive" @refetch-data="refetchData"
    ...
    <b-card no-body class="mb-0">
          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button variant="primary" @click="isAddSidebarActive = true"
                v-if="hasPermission('images-slider-add-or-edit')">
                <span class="text-nowrap">Add Image Itinerary</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchSales" responsive hover
        ...
        <template #cell(image_url)="data">
          <div class="" v-if="includesSearchText(data.item.image_url)">
        ...
        <template #cell(actions)="data">
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item :to="{ name: 'image-itinerary-detail', params: { id: data.item.id } }">
              <feather-icon icon="FileTextIcon" />
              <span class="align-middle ml-50">Details</span>
            </b-dropdown-item>
            <b-dropdown-item variant="danger" @click="deleteTourPackage(data.item)">
...
import { deleteData } from '@/network/web-itinerary'

            ...
            <b-form @submit.prevent="onSubmit">
                ...
                <validation-observer ref="refObsForm">
                    ...
                    <b-row>
                        ...
                        <!-- Slider Title -->
                        <b-col cols="12" md="4">
                            <validation-provider #default="{ errors }" name="Slider Title" vid="title" rules="required">
                                <b-form-group label="Slider Title">
                        ...
                        <!-- Slider URL -->
                        <b-col cols="12" md="4">
                            <validation-provider #default="{ errors }" name="Slider URL" vid="slider_url" rules="required">
                                <b-form-group label="Slider URL">
                                <b-form-input id="slider_url" v-model="formData.slider_url" :state="errors.length > 0 ? false : null"
                                trim />
                    ...
                    <b-row>
                        ...
                        <!-- Overlay -->
                        <b-col cols="12" md="4">
                            <validation-provider #default="{ errors }" name="Overlay Image" vid="overlay" rules="required">
                              <b-form-group label="Overlay Image">
                                <b-form-checkbox v-model="formData.overlay" name="check-button" switch />
...
import { getDetail } from '@/network/main-visual'
import { ValidationProvider, ValidationObserver } from 'vee-validate'
import { required, numeric } from '@validations'
import Ripple from 'vue-ripple-directive'
import vSelect from 'vue-select'
import { avatarText } from '@core/utils/filter'
import { postData } from '@/network/main-visual'
...
export default {
        ...
        onSubmit() {
            this.$refs.refObsForm.validate().then(success => {
                ...
                postData(vForm).then(response => {
                    this.$bvToast.toast('Main visual has been changed successfully', {
                        title: `Success`,
                        variant: 'primary',
    ...
    data() {
        ...
        getDetail(id).then(response => {
            ...
            this.formData['overlay'] = (response.data['overlay'] == 1) ? true : false
        }).catch(error => {
            if (error.response.data.errors) {
                this.$refs.refObsForm.setErrors(error.response.data.errors)
            } else {

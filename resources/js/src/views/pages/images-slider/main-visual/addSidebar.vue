      ...
      <validation-observer ref="refObsForm">
        ...
        <b-form class="p-2" @submit.prevent="onSubmit" @reset.prevent="resetMainVisualData">
          ...
          <validation-provider #default="{ errors }" vid="image" name="Image" rules="required">
            <b-form-group label="Image" description="Recommended Size 1080 x 780 px (Format : PNG, JPG, WEBP) Max Size: 1.5MB">
          ...
          <!-- Overlay -->
          <validation-provider #default="{ errors }" name="Overlay Image" vid="overlay">
...
export default {
  ...
  data() {
    return {
      ...
      required,
      numeric,
      formData: {status:true,overlay:true}
    }
  },
  methods: {
    resetMainVisualData() {

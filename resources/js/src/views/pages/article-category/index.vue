<template>
    <div>
        <add-sidebar
            ...
            v-if="hasPermission('article-add-or-edit')"
        />
        ...
        <b-card no-body class="mb-0">
            ...
            <b-table ref="refUserListTable" class="position-relative" :items="fetchData" responsive hover 
            ...
            :sort-desc.sync="isSortDirDesc">
                ...
                <template #cell(actions)="data">
                    ...
                    >
                        ...
                        <b-dropdown-item :to="{ name: 'article-category-detail', params: { id: data.item.id } }">
...
import { deleteData } from "@/network/article-category";

<template>
  <div>
    <add-sidebar :is-add-sidebar-active.sync="isAddSidebarActive"
      @refetch-data="refetchData" v-if="hasPermission('web-sales-add-or-edit')" />
        ...
        <b-row>
          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button variant="primary" @click="isAddSidebarActive = true" v-if="hasPermission('web-sales-add-or-edit')">
                <span class="text-nowrap">Add Sales</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchSales" responsive hover
        ...
        <template #cell(actions)="data">
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item :to="{ name: 'web-sales-detail', params: { id: data.item.id, name: data.item.sales_name } }">
...
import { deleteData } from '@/network/web-sales'
...
export default {
  ...
  methods : {
    deleteSale(item){
        this.$swal({
        title: `Delete Sale ${item.sales_name}?`,

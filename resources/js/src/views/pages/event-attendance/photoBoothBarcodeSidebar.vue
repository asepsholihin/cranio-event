<template>
  <b-sidebar id="photo-booth-barcode-sidebar" :visible="isPhotoBoothBarcodeSidebarActive" bg-variant="white" sidebar-class="sidebar-lg" shadow
    ...
    <template #default="{ hide }">
      ...
      <div class="d-flex justify-content-between align-items-center content-sidebar-header px-2 py-1">
        <h5 class="mb-0">Photo Booth Barcode</h5>
...
export default {
  ...
  model: {
    prop: 'isPhotoBoothBarcodeSidebarActive',
    event: 'update:is-photo-booth-barcode-sidebar-active',
  },
  props: {
    eventAttendance: {
      type: Object,
  ...
  methods: {
    ...
    onSubmit() {
      this.$refs.refObsForm.validate().then(success => {
        ...
        vForm.append('act', 'photoBoothBarcode')

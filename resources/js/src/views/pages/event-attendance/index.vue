    ...
    <b-card no-body class="mb-0">
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchUsers" responsive hover
        ...
        <template #cell(report)="data">
            <b-button class="mr-1" variant="warning" size="sm" :to="{ name: 'attendance-report', params: { id: data.item.id, online: 'offline' } }"><feather-icon icon="PieChartIcon" /><span class="align-middle ml-50">Offline</span></b-button>
        </template>

...
const resourcePath = '/spa/participant-merchandise'
...
export const postAddParticipant = (...args) => {
    return httpService.getHttp().post(resourcePath + '/add-participant', ...args)
}

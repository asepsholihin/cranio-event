...
const resourcePath = '/spa/vendor'

export const getList = (...args) => {
    return httpService.getHttp().get(resourcePath, ...args)
}

export const getListVendor = (...args) => {
    return httpService.getHttp().get(resourcePath+'-list-vendor', ...args)
}
...
export const getVendorSearch = (args) => {

...
class SendWhatsappBookingInvoice implements ShouldQueue
{
    ...
    public function __construct($order, $invoice)
    {
        ...
        $qontakTemplate = DB::table('qontak_templates')->where('name', 'booking-order-invoices')->first();
    ...
    public function handle()
    {
        try {
            ...
            $body = [
                ...
                new Body($currency . " " . number_format($this->invoice->payment, 0, ',', '.')),
            ...
            LogQontakBroadcast::create([
                ...
                'type' => 'Kirim link invoice pembayaran lanjutan',
                'status' => 'Delivered',

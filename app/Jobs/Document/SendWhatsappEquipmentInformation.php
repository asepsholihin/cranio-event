...
class SendWhatsappEquipmentInformation implements ShouldQueue
{
    ...
    public function __construct($order)
    {
        App::setLocale('id');
        $this->order = $order;
        $qontakTemplate = DB::table('qontak_templates')->where('name', 'equipment-information')->first();
    ...
    public function handle()
    {
        ...
        try {
            ...
            LogQontakBroadcast::create([
                ...
                'type' => 'Informasi Kelengkapan Dokumen',
                'status' => 'Delivered',

...
class SendWhatsappDocumentInformation implements ShouldQueue
{
    ...
    public function __construct($order)
    {
        App::setLocale('id');
        $this->order = $order;
        $qontakTemplate = DB::table('qontak_templates')->where('name', 'document-information')->first();
    ...
    public function handle()
    {
        ...
        try {
            ...
            LogQontakBroadcast::create([
                ...
                'type' => 'Informasi Kirim Perlengkapan',
                'status' => 'Delivered',

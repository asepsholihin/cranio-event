...
class SendWhatsappOrderJios implements ShouldQueue
{
    ...
    public function __construct($order, $invoice)
    {
        ...
        $qontakTemplate = DB::table('qontak_templates')->where('name', 'booking-order-create-invoice')->first();
    ...
    public function handle()
    {
        try {
            ...
            LogQontakBroadcast::create([
                ...
                'type' => 'Kirim link invoice saat booking order',
                'status' => 'Delivered',

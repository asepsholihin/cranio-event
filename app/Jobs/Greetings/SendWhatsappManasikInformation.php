...
class SendWhatsappManasikInformation implements ShouldQueue
{
    ...
    public function __construct($order)
    {
        App::setLocale('id');
        $this->order = $order;
        $qontakTemplate = DB::table('qontak_templates')->where('name', 'manasik-information')->first();
    ...
    public function handle()
    {
        ...
        $body = [
            new Body("Untuk informasi awal terkait persiapan keberangkatan Umrah, silahkan klik FAQ berikut ini https://www.jejakimani.com/faq")
        ];

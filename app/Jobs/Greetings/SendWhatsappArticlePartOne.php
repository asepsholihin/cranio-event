...
class SendWhatsappArticlePartOne implements ShouldQueue
{
    ...
    public function __construct($order)
    {
        App::setLocale('id');
        $this->order = $order;
        $qontakTemplate = DB::table('qontak_templates')->where('name', 'article-part-1')->first();
    ...
    public function handle()
    {
        ...
        $body = [
            new Body("https://www.jejakimani.com/artikel/jangan-abaikan-hal-ini!-bisa-bikin-umrah-anda-sia-sia")
        ];

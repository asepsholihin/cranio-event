...
class SendWhatsappMiladCard implements ShouldQueue
{
    ...
    public function __construct($participantId, $image = "")
    {
        ...
        $this->photo = (new MiladCard($participant, true, $image))->streamPublic();
    ...
    public function handle()
    {
        ...
        $fileName = "Milad_Card_" . str_replace(" ", "_", $this->name)."_".Carbon::now()->timestamp.".jpg";
        ...
        $header = new Header(
            Header::TYPE_IMAGE, $this->photo, $fileName
        );

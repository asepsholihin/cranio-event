...
class SendWhatsappBookingBadal implements ShouldQueue
{
    ...
    public function __construct($order, $invoice)
    {
        ...
        $qontakTemplate = DB::table('qontak_templates')->where('name', 'create-invoice-badal-xendit')->first();
    ...
    public function handle()
    {
        ...
        $body = [
            ...
            new Body("Rp " . number_format($this->order->total_payment, 0, ',', '.')),
        ...
        try {
            ...
            LogQontakBroadcast::create([
                ...
                'type' => 'Kirim link invoice badal xendit',
                'status' => 'Delivered',

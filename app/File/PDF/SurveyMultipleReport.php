...
class SurveyMultipleReport
{
    ...
    public function __construct($request)
    {
        ...
        foreach ($forms as $key => $form) {
            $questions = FormQuestion::where('form_id', $form->id)->where('view_in_report', true)->orderBy('order','asc')->get();
        ...
        $this->pdf = PDF::loadView('pdf.survey_multiple_report', $data);
    ...
    {
        return view('pdf.survey_multiple_report', $this->data)->render();
    }
}

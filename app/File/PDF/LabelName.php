...
class LabelName
{
    ...
    public function __construct($umrohTripId)
    {
        ...
        // return view('pdf.label_names', $data)->render();
        $this->pdf = PDF::loadView('pdf.label_names', $data);
    ...
    {
        return $this->pdf->download("LABEL_NAME_".$this->umrohTrip->title.'.pdf');
    }
    ...
    {
        return view('pdf.label_names', $this->data)->render();
    }
}

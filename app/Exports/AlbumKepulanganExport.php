...
class AlbumKepulanganExport implements FromQuery, ShouldAutoSize, WithHeadings, WithStyles, WithMapping, WithEvents
{
    private $rowNumber;
    private $request;
    private $equipments;
    ...
    */
    public function query()
    {
        ...
        $query->orderByRaw('no_urut ASC, package_type ASC, booking_order_no ASC');
        return $query;
    }
